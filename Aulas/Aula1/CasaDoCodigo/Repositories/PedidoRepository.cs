...
namespace CasaDoCodigo.Repositories
{
    ...
    public class PedidoRepository : BaseRepository<Pedido>, IPedidoRepository
    {
        ...
        public void AddItem(string codigoProduto)
        {
            ...
            {
                //ItemPedido itemPedidoUpdate = new ItemPedido(itemPedido.Pedido, itemPedido.Produto, itemPedido.Quantidade + 1, itemPedido.PrecoUnitario);

                //contexto.Set<ItemPedido>().Update(itemPedido);
            }
        ...
        public UpdateQuantidadeResponse UpdateQuantidade(ItemPedido itemPedido)
        {
            ...
            if (itemPedidoDB != null)
            {
                ...
                contexto.SaveChanges(); //ta pegando de produto?
